...
class stale_dns_cache(Plugin):
    ...
    def audit(self, directive):
        ...
        for upstream in directive.find_imperative_directives_in_scope("upstream", True):
            ...
            upstream_name = upstream_args[0] if upstream_args and len(upstream_args) == 1 else None
            if upstream_name and (upstream_name == parsed_host or upstream_name in upstream_name_candidates):
                found_upstream = True
